...
//  创建一条音乐
    ...
    $item.get(0).index = index;  //拿到所点击的歌曲的索引，得到Dom对象
    ...
    function initMusicInfo(music){
        ...
        // 给获取到的元素赋值
        $musicImage.attr("src", music.cover);  //修改元素属性
        $musicName.text(music.name);           //修改元素内容
    ...
    function initEvents() {
        ...
        $(".content_list").delegate(".list_menu_play", "click", function () {
            var $item = $(this).parents(".list_music"); //找到祖先.list_music
